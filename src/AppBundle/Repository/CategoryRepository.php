...
class CategoryRepository extends EntityRepository
    {
	     public function findAllOrderedById()
         {
		        return $this->getEntityManager()
		                    ->createQuery( 'SELECT n FROM AppBundle:category n
				                            ORDER BY n.id DESC' ) 
					        ->getResult();
         }
    ...
    public function findAllvisable()
        {
            return $this
                ->createQueryBuilder('n')
                ->select('n')
        ...
        public function findIconeCategory($limit)
            {
                return $this
                    ->createQueryBuilder('c')
                    ->select('c')
                    ->where('c.homeDisplay = :true')
            ...
            public function findlogoCategory($limit)
                        {
                            return $this
                                ->createQueryBuilder('c')
                                ->select('c')
